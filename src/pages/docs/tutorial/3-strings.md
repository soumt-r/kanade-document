...
`『名前』の『長さ』`で、文字がいくつあるか分かります。ひらがなも絵文字も、1文字として数えます。

```kanade
『名前』を【文字列】の「山田太郎」にしよう
枠「名前は{『名前』の『長さ』}文字です。」を出力しよう
```

### 文字列は作ったあとで変えられません

文字列の何番目かの文字だけをこっそり変えることはできません。
...
変えたいなら、望む形の**新しい文字列**を作って入れ直しましょう。

```kanade
『名前』を【文字列】の「山田太郎」にしよう
『名前』を【文字列】の「木」 + 『名前』の〈切り取り〉(2, 4)にしよう
『名前』を出力しよう
```

文字を1つずつ取り出して扱う方法は、[7章](/docs/tutorial/7-loops)にあります。
